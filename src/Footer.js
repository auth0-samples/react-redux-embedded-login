  ...
  render() {
    ...
    return (
      ...
      <div className="container">
        <div className="sc-foote_r_logo">
          <img alt="Auth0 Badge "className="sc-footer__logo-image" src="https://cdn.auth0.com/styleguide/components/1.0.8/media/logos/img/badge.png" width="30" />
        </div>
